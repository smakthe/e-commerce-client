...
const Products = () => {
  ...
  const ProductCarousel = ({
    ...
    <div className="mb-16">
      ...
      <div
        className="flex overflow-x-auto snap-x snap-mandatory gap-6 pb-6 w-full hide-scrollbar"
    ...
    <div className="container mx-auto py-12 px-4 md:px-6 min-h-screen">
      ...
      {loading && !exploreData && searchProducts.length === 0 ? (
        ...
        <div className="animate-in fade-in duration-700">
          ...
          {exploreData.most_expensive &&
            exploreData.most_expensive.length > 0 && (
              <ProductCarousel
